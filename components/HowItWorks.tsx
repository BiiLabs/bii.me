  ...
  <Section background="white">
    ...
    <Row style={{ width: '100%', padding: '48px 0 52px' }}>
      <Item
        ...
        title="Get BiiMe DID"
        icon={getRelativePath('/static/icon3Getbiime@2x.png')}
      ...
      <Item
        color="rgb(58,173,212)"
        title="Licensing"
        icon={getRelativePath('/static/icon3Licensing@2x.png')}
      ...
      <Item
        color="rgb(58,173,212)"
        title="Verification"
        icon={getRelativePath('/static/icon3Verfivation@2x.png')}
      ...
      <Item
        ...
        icon={getRelativePath('/static/icon3AccessService@2x.png')}
